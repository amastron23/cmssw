...
namespace trklet {
  ...
  private:
    ...
    static constexpr std::array<std::initializer_list<Variable>, +Process::end> tracks_ = {{
        ...
        {Variable::reversedHitPattern, Variable::mva, Variable::chi20, Variable::chi21, Variable::zT, Variable::cot},  // Process::tq
        {}                                                                                // Process::tfp
    }};
  ...
  class TrackTQ : public Track<TTBV, int, double, double, double, double> {
  public:
    ...
    TrackTQ(const TrackKF& track, const TTBV& reversedHitPattern, int mva, double chi20, double chi21, double zT, double cot)
        : Track(track, reversedHitPattern, mva, chi20, chi21, zT, cot) {}
    TrackTQ() {}
